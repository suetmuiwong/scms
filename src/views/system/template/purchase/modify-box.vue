<template>
  <div>
    ...
    <el-dialog
      :title="boxParams.type === 'edit' ? '编辑采购结果通知书模板': '新建采购结果通知书模板'"
    ...
    >
      <div slot="title" class="dialog-header">
        <div class="dialog-custom-header">
          <i class="line-icon"></i>
          <span class="header-title">{{boxParams.type === 'edit' ? '编辑采购结果通知书模板': '新建采购结果通知书模板'}}</span>
        </div>
        <div>
      ...
      <el-collapse accordion  v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <div class="collapse-content">
            <el-form :model="form" ref="form" label-width="190px" class="basic-form" size="small" :rules="rules">
